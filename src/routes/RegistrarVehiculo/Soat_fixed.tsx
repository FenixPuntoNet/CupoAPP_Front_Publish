...
import { getSoat, registerSoat, uploadSoatPhotos, fileToBase64, type SoatFormData as BackendSoatFormData } from '@/services/vehicles';
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const soatData: BackendSoatFormData = {
                vehicle_id: 0, // Backend will handle the vehicle association
